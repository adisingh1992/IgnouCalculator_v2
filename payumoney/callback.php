    ...
    if($_SERVER["REQUEST_METHOD"] === "POST" && isset($_SESSION['user']['eno'])){
        ...
        if($hash !== $posted_hash){
            ...
            if($status === "failure"){
                ...
                include_once "project_sender.php";
                ...
                echo "<p>You will recieve your project soon in your mail..!!</p>";
                echo "<a href='../projects.php'>Take Me Back</a>";
                echo "<br/><cite>If for some reason you don't recieve the project, please also check your spam folder or you can also contact us at mail@ignoucalculator.com</cite>";
            }
        }
    }
?>